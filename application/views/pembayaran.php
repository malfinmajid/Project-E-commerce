    ...
    <section class="breadcrumb-section pb-3 pt-3">
        <div class="container">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="#" style="color: #8b0000;">Detail Cart</a></li>
...
<div class="container-fluid">
	<div class="row">
		...
		<div class="col-md-8">
			<div class="alert mt-3 text-center" style="background-color: #8b0000;">
				...
				if ($keranjang = $this->cart->contents())
				{
					...
					?>
					<h6 class="mt-2" style="color: white;">Silahkan Masukkan Alamat Pengiriman dan Metode Pembayaran Anda</h6>
			...
			<form  action="<?php echo base_url('dashboard/proses_pesanan'); ?> " method="post">
				...
				<select class="form-control" name="metode_pembayaran">
						<option>BCA - 01-000-2222-3333-50</option>
						<option>BRI - 02-000-2233-345-35</option>
						<option>BNI - 044-000-2244-678-26</option>
						<option>MANDIRI - 021-000-2255-890-40</option>
					</select>
				</div>

				<button type="submit" class="btn btn-sm mt-2 mb-5" style="background-color: #8b0000; color: white;">Pesan</button>

			</form>

			<?php
		}else{
			echo "<h4 style='color: white;'>Keranjang Belanja Anda Masih Kosong!";
		}
		   ?>
		</div>
		</div>
