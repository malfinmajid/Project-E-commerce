...
<div class="container-fluid">
	<div class="alert mt-3" style="background-color: #8b0000;">
		<h5 class="text-center align-middle" style="color: white;">Pesanan Anda Segera Diproses</h5>
	...
	<div class="col-md-2"></div>
	<img src="<?php echo base_url() ?>assets/uploads/berhasil12.png" style="width: 400px;"><br><br>
	...
	<a class="btn btn-sm mt-4 mb-5 text-center ml-5" style="background-color: #8b0000; color: white;" href="<?php echo base_url('welcome') ?>">Home</a>
	</div>
	</div>
</div>
