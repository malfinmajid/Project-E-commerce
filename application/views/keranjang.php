    ...
    <section class="breadcrumb-section pb-3 pt-3">
        <div class="container">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="#" style="color: #8b0000;">Products</a></li>
                <li class="breadcrumb-item"><a href="#" style="color: #8b0000;">Product Detail</a></li>
                <li class="breadcrumb-item active" aria-current="page">Detail Cart</li>
            </ol>
        </div>
    </section>
...
<div class="container-fluid mt-5">
    ...
    <table class="table table-bordered table-striped table-hover mt-3">
        <tr>
            ...
            <th class="text text-center">Nama Barang</th>
            <th class="text text-center">Keterangan</th>
            <th class="text text-center">Jumlah</th>
            <th class="text text-center">Harga</th>
        ...
        <td colspan="2" align="center">Rp. <?php echo number_format($this->cart->total(), 0,',','.') ?></td>
        </tr>
    </table>

    <div align="right">
        <a href="<?php echo base_url('dashboard/batal') ?>"><div class="btn btn-sm btn-secondary mb-5">Batal</div></a>
        <a href="<?php echo base_url('welcome/index') ?>"><div class="btn btn-sm btn-dark mb-5">Lanjut Belanja</div></a>
        <a href="<?php echo base_url('dashboard/pembayaran') ?>"><div class="btn btn-sm btn-secondary mb-5">Pembayaran</div></a>
    </div>
