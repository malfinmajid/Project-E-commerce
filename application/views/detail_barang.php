...
<div class="card mb-3 mt-3 mx-auto" style="max-width: 800px;">
  ...
  <div class="row g-0">
    <div class="col-md-4">
      <img src="<?php echo base_url().'/assets/img/products/'.$brg->gambar ?>" style="width: 300px;" alt="...">
    </div>
    <div class="col-md-8">
    ...
    <?php echo anchor('dashboard/tambah_ke_keranjang/'.$brg->id_brg,'<div class="btn btn-sm ml-4" style="background-color: #8b0000; color: white;">Tambah ke Keranjang</div>') ?>

    <?php echo anchor('welcome/index','<div class="btn btn-sm btn-secondary" style="color: #8b0000;">Kembali</div>') ?>
